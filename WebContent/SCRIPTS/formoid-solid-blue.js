		...
		b.prototype={constructor:b,toggle:function()
				...
				this.isShown=!0,this.escape(),this.backdrop(function()
						...
						c?b.$element.one(a.support.transition.end,
								function()
								{b.$element.focus().trigger("shown")}):b.$element.focus().trigger("shown")})},
								hide:function(b)
								{b&&b.preventDefault();
								var c=this;b=a.Event("hide"),
												...
												{var b=this,c=setTimeout(function()
														...
														this.$element.one(a.support.transition.end,
																...
																this.backdrop(function()
																		...
																		this.$backdrop=null},backdrop:function(b)
														...
														{return this.each(function()
																...
																a(document).on("click.modal.data-api",'[data-toggle="modal"]',
																		...
																		f=e.data("modal")?"toggle":a.extend({remote:!/#/.test(d)&&d},e.data(),
																		c.data());
																		b.preventDefault(),
																		e.modal(f).one("hide",function()
																				{c.focus()})})}(window.jQuery),
																				!function(a){function d()
																				{a(".dropdown-backdrop").remove(),a(b).each(function()
																						{e(a(this)).removeClass("open")})}function e(b)
																						{var c=b.attr("data-target"),d;c||(c=b.attr("href"),
																						...
																						c.prototype={constructor:c,toggle:function(b)
																								...
																								return f=e(c),g=f.hasClass("open"),
																								d(),
																								...
																								{return this.each(function()
																										...
																										a(document).on("click.dropdown.data-api",d).on("click.dropdown.data-api",".dropdown form",
																												function(a){a.stopPropagation()}).on("click.dropdown.data-api",b,c.prototype.toggle).on("keydown.dropdown.data-api",b+", [role=menu]",
																														c.prototype.keydown)}
																				(window.jQuery),!function(a)
																				{function b(b,c)
																				{var d=a.proxy(this.process,this),
																					...
																					c=this.$body.find(this.selector).map(function()
																							...
																							e=/^#\w/.test(d)&&a(d);
																							return e&&e.length&&[[e.position().top+(!a.isWindow(b.$scrollElement.get(0))&&b.$scrollElement.scrollTop()),d]]||null}).sort(function(a,b)
																										{return a[0]-b[0]}).each(function()
																												...
																												{var a=this.$scrollElement.scrollTop()+this.options.offset,
																													...
																													e=this.targets,
																													f=this.activeTarget,
																													g;if(a>=c)return f!=(g=e.last()[0])&&this.activate(g);
																				...
																				(window.jQuery),!function(a)
																					{var b=function(b)
																						...
																						{constructor:b,show:function()
																								...
																								b.trigger(g);if(g.isDefaultPrevented())return;
																						...
																						{constructor:b,init:function(b,c,d)
																								...
																								h=="click"?this.$element.on("click."+this.type,this.options.selector,a.proxy(this.toggle,this)):h!="manual"&&(e=h=="hover"?"mouseenter":"focus",f=h=="hover"?"mouseleave":"blur",
